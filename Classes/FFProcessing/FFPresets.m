...
- (void)apply:(AVCodecContext *)codecContext {
  if (!_codecName || [_codecName isEqualToString:@"mpeg4"]) {
  ...
  } else if ([_codecName isEqualToString:@"libxvid"]) {
    codecContext->gop_size = 999999;
    codecContext->max_b_frames = 0;
    codecContext->bit_rate = 20000*1000;    
  } else if ([_codecName isEqualToString:@"libx264"]) {
    codecContext->gop_size = 999999;
    // Defaults

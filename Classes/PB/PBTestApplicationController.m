...
#import "PBTestApplicationController.h"
...
@implementation PBTestApplicationController
...
- (void)_showError:(NSError *)error {
  [YKUIAlertView showOKAlertWithMessage:[NSString stringWithFormat:@"There was a problem (%@)", [error localizedDescription]] title:@"Oops"];
}
